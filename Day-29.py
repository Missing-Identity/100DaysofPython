...
<span class="s0">def </span><span class="s1">save():</span>
    ...
    <span class="s0">else</span><span class="s1">:</span>
        <span class="s2"># This returns a boolean value</span>
        <span class="s1">is_ok = messagebox.askokcancel(title=</span><span class="s3">&quot;Confirmation&quot;</span><span class="s0">, </span><span class="s1">message=</span><span class="s3">f&quot;Are you sure the following information is ok? &quot;</span>
                                                                     <span class="s3">f&quot;</span><span class="s0">\n</span><span class="s3">Website: </span><span class="s0">{</span><span class="s1">website</span><span class="s0">} \n</span><span class="s3">Username: </span><span class="s0">{</span><span class="s1">username</span><span class="s0">} \n</span><span class="s3">&quot;</span>
        ...
        <span class="s0">if </span><span class="s1">is_ok:</span>
            <span class="s0">with </span><span class="s1">open(</span><span class="s3">&quot;Saved_passwords.txt&quot;</span><span class="s0">, </span><span class="s1">mode=</span><span class="s3">&quot;a&quot;</span><span class="s1">) </span><span class="s0">as </span><span class="s1">file:</span>
                <span class="s1">file.write(</span><span class="s3">f&quot;Website:</span><span class="s0">{</span><span class="s1">website</span><span class="s0">} </span><span class="s3">| Username:</span><span class="s0">{</span><span class="s1">username</span><span class="s0">} </span><span class="s3">| Password:</span><span class="s0">{</span><span class="s1">password</span><span class="s0">}</span><span class="s3">&quot;</span>
...
<span class="s1">website_entry = Entry(width=</span><span class="s4">35</span><span class="s0">, </span><span class="s1">highlightbackground=</span><span class="s3">&quot;#e32636&quot;</span><span class="s1">)</span>
...
<span class="s1">website_entry.grid(column=</span><span class="s4">1</span><span class="s0">, </span><span class="s1">row=</span><span class="s4">1</span><span class="s0">, </span><span class="s1">columnspan=</span><span class="s4">2</span><span class="s1">)</span>
